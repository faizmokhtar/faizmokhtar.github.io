(function (jtd, undefined) {
    ...
    function initNavBar() {
      return fetch("https://notes.faizmokhtar.com/nav.html").then(function (response) {
    ...
    function initSearch() {
      ...
      request.open("GET", "https://notes.faizmokhtar.com/assets/js/search-data.json", true);
    ...
    jtd.setTheme = function (theme) {
      ...
      cssFile.setAttribute(
        "href",
        'https://notes.faizmokhtar.com/assets/css/just-the-docs-' + theme + ".css"
      );
    };
